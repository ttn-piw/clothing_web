...
<head>
    ...
    <title>Admin's Page Search</title>
    ...
    <section class="admin-content">
        ...
        <div class="admin-content-right">
            ...
            <div class="find_product">
                <form action='admin_page_search.php' method='post'>
                    <i class="fa-solid fa-magnifying-glass"></i><input type="text" name="find_field" placeholder="Tìm kiếm sản phẩm">
            ...
            <table>
                ...
                if(isset($_POST['search'])){
                    $key = trim($_POST['find_field']);
                    $search_key = str_replace(" ","%' OR p.PName LIKE '%", trim($key)); //search for many keys
                    $sql_query = "  SELECT * FROM product p JOIN categories c 
                                ON  p.CTG_ID = c.CTG_ID WHERE UPPER(p.PName) LIKE UPPER('%$search_key%')";
